module {
  func.func @main() -> i8 {
    ...
    %0 = memref.alloc(%c1_i64) : memref<?xi8>
    %1 = memref.alloc(%c1_i64) : memref<?xi8>
    ...
    affine.for %arg0 = 0 to 10000000 {
      ...
      memref.store %c5_i8, %0[%c1_i64] : memref<?xi8>
      memref.store %3, %1[%c1_i64] : memref<?xi8>
    }

    // %2 = llvm.load %0 : !llvm.ptr<i8>
    %2 = memref.load %0[%c1_i64] : memref<?xi8>
